...
class HowToDelete extends StatefulWidget {
  @override
  _HowToDeleteState createState() => _HowToDeleteState();
}

class _HowToDeleteState extends State<HowToDelete> {
  ...
  final List<Widget> _pages = [
    IntroPage("assets/images/howdelete1.jpg","", "ไปที่รายการที่ต้องการจะลบ \n \n เลือกรายการที่ต้องการจะลบ"),
    IntroPage("assets/images/howdelete2.png","", "เมื่อเลือกเสร็จแล้วจะมีแจ้งเตือนขึ้นมา  \n \n ถ้าต้องการลบให้กดปุ่ม ใช่ ถ้าไม่ให้กดปุ่ม ไม่"),
  ];
